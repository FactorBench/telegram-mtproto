...
class ApiManager {
  constructor(config, tls, netFabric, { on, emit }) {
    ...
    function* _ref6(method, params, options = {}) {
      ...
      var dcID = options.dcID || (yield _this.storage.get('dc')) || baseDcID;

      yield _this.initConnection(dcID);
    ...
    this.auth = (0, _authorizer2.default)(this.TL, this.keyManager, this.apiConfig.platform);
  ...
  initConnection(dcID) {
    ...
    return _asyncToGenerator(function* () {
      if (!isAnyNetworker(_this2)) {
        yield _this2.storage.set('dc', dcID);
        yield _this2.mtpGetNetworker(dcID, { createNetworker: true });
