...
var Auth = exports.Auth = ({ Serialization, Deserialization }, { select, prepare }, platform) => {
  function* _ref4(auth) {
  ...
  var sendPlainReq = (0, _sendPlainReq2.default)({ Serialization, Deserialization }, platform);
  ...
  function mtpAuth(dcID, cached, dcUrl) {
    ...
    var nonce = [];
    for (var i = 0; i < 16; i++) {
      nonce.push((0, _bin.nextRandomInt)(0xFF));
