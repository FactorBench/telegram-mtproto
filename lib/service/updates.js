...
var UpdatesManager = api => {
  ...
  var getUserID = (() => {
    var _ref = _asyncToGenerator(_ref6);
  ...
  function* _ref9() {
    ...
    differenceResult.new_messages.forEach(_ref8);
  ...
  var getDifference = (() => {
    var _ref3 = _asyncToGenerator(_ref9);
  ...
  function* _ref10(channelID) {
    ...
    if (differenceResult._ == 'updates.channelDifference' && !differenceResult.pFlags['final']) {
  ...
  var getChannelDifference = (() => {
    var _ref4 = _asyncToGenerator(_ref10);
  ...
  function popPendingPtsUpdate(channelID) {
    ...
    curState.pendingPtsUpdates.sort(_ref13);
  ...
  function processUpdateMessage(updateMessage) {
    ...
    switch (updateMessage._) {
      ...
      case 'updates':
        ...
        updateMessage.updates.forEach(_ref14);
        break;
    ...
    if (update.pts) {
      ...
      if (newPts < update.pts) {
        ...
        if (!curState.syncPending) {
          curState.syncPending = {
            timeout: setTimeout(_ref15, 5000)
          };
        }
      ...
      if (seqStart != curState.seq + 1) {
        if (seqStart > curState.seq) {
          ...
          if (!curState.syncPending) {
            curState.syncPending = {
              timeout: setTimeout(_ref16, 5000)
            };
          }
